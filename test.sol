...
contract ERC20Token is ERC20Interface, Owned {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor(string memory _symbol, string memory _name, uint8 _decimals, uint _initialSupply, address _tokenOwner) public {
        symbol = _symbol;
        name = _name;
        decimals = _decimals;
        _totalSupply = _initialSupply;
        balances[_tokenOwner] = _initialSupply;
...
contract ERC865Token is ERC20Token {
    ...
    function approveFrom(address _from, address _to, uint256 _value)
        internal
    {
        ...
        onlyOwner
    {
        ...
        bytes32 message = keccak256(abi.encodePacked(_from, _to, _value));
        require(recoverSigner(message, _signature) == _from);
        
        approveFrom(_from, msg.sender, _value);
